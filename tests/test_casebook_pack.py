"""Regression checks for the radian-tool-lint-scope casebook."""
...
from casebook.harness import assert_expected, radian_tool_lint_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_tool_lint_scope_summary(), assert_expected())
